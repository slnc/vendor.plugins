module Stats
  class Goals
    ...
    def self.total_clickthrough(opts)
      clickthrough(opts.merge(:total => true))
    end
    
    def self.date_constraints(opts)
    ...
    def self.visitor_id_constraint(opts)
    ...
    def self.user_id_constraint(opts)
    ...
    def self.avg_pages_per_visitor(opts)
    ...
    def self.treated_visitors(opts)
      # visitantes tratados
